					...
					<div class="row">
						...
						<div class="col-md-12">
							<div class="price-wrap">
								...
								<span class="price-per-day">10,00 (за одни сутки аренды)</span>
							</div>
							<div class="buttons-block" style="margin-right:0;">
								<?if($bShowOrderBlock):?>
								<div class="block" style="margin-left:auto;margin-right:auto;">
									<!-- <span class="btn btn-default btn-lg animate-load" data-event="jqm" data-param-id="<?= ($arParams["FORM_ID_ORDER_SERVISE"] ? $arParams["FORM_ID_ORDER_SERVISE"] : CAllcorp2::getFormID("aspro_allcorp2_order_project")); ?>" data-name="order_services" data-autoload-service="<?= CAllcorp2::formatJsName($arResult['NAME']) ?>" data-autoload-study="<?= CAllcorp2::formatJsName($arResult['NAME']) ?>" data-autoload-project="<?= CAllcorp2::formatJsName($arResult['NAME']) ?>"><span><?= (strlen($arParams['S_ORDER_SERVISE']) ? $arParams['S_ORDER_SERVISE'] : Loc::getMessage('S_ORDER_SERVISE')) ?></span></span> -->
									<a class="btn btn-default btn-lg" href="#"><span><?= (strlen($arParams['S_ORDER_SERVISE']) ? $arParams['S_ORDER_SERVISE'] : Loc::getMessage('S_ORDER_SERVISE')) ?></span></a>
								</div>
								<?endif;?>
								<?if($bShowAskBlock):?>
								<div class="block" style="margin-left:auto;margin-right:auto;">
								...
								<div class="text" style="text-align: center;">
									<p style="margin-bottom:0">*Доп. оплачиваются расход. материалы: <strong>нет</strong></p>
									<p style="margin-bottom:0">Доп. оплачиваются амбулат. прием: <strong>нет</strong></p>
