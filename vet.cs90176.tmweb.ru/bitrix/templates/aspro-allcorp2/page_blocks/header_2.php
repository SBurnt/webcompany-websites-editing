		...
		<div class="maxwidth-theme">
			...
			<div class="top-block-item pull-right">
				<div class="phone-block">
					...
					<?endif;?>
					<div class="inline-block">
						<a class="btn btn-default btn-call-home" href="#"><span>Вызвать врача на дом</span></a>
					</div>
					<div class="inline-block">
						<a class="btn btn-default btn-schedule" href="#"><span>Расписание специалистов</span></a>
					</div>
				</div>
			</div>
			<div class="top-block-item pull-right">
