...
return [
    ...
    'templates' => [
        ...
        <div class="slider-main">
            <ul class="bx-slider" data-auto_mode="[+auto_mode+]" data-pause="[+pause+]">
                [+slider_main+]
            </ul>
        </div>
        ',
        ...
        <li style="background-image: url([+image_background+]);">
            <img src="[+image_background+]" alt="Слайд [+header+]" class="slide-img" loading="lazy">
            <div class="full-slide container">
                ...
                <!-- <div class="slider_main__btn-wrap">
                    [+more_button+]
                    [+form_button+]
                </div> -->
            </div>
    ...
    'fields' => [
        ...
        'pause' => [
            'caption' => 'Время между пролистыванием, секунд',
            'type' => 'text',
            'default' => '5'
        ],
    ...
    'prepare' => function ($options, &$values) {
        ...
        $values['pause'] = $values['pause'] * 1000;
