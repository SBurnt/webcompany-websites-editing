								...
								case 'buttons':
									...
									<div data-entity="main-button-container" class="mb-3">
										<div id="<?=$itemIds['BASKET_ACTIONS_ID']?>" style="display: <?=($actualItem['CAN_BUY'] ? '' : 'none')?>;">
											...
											<?php if($USER->IsAdmin()):?>
												<div class="mb-3 kl">
													<a data-fancybox href="#modal-fast-wrap" class="btn basket__fast-order modal-fast-wrap">Купить в 1 клик</a>
												</div>
											<?php endif; ?>
										</div>
									</div>
...
global $my_title;
$my_title = $sotbitSeoMetaH1;
$ipropValues = new \Bitrix\Iblock\InheritedProperty\ElementValues($arParams["IBLOCK_ID"], $arResult['ID']);
$arResult1["IPROPERTY_VALUES"] = $ipropValues->getValues();
?>
<?if(!empty($sotbitSeoMetaTitle)){?>

<?$this->SetViewTarget("h1_title");?>
<?=$sotbitSeoMetaH1?>
<?$this->EndViewTarget();?>

<?}else{?>
<?$SeoMetaTitle = $arResult1["IPROPERTY_VALUES"]["SECTION_META_TITLE"]?>
<?$APPLICATION->SetTitle($SeoMetaTitle);?>
<?$APPLICATION->SetPageProperty("title", $SeoMetaTitle);?>
<?$this->SetViewTarget("h1_title");?>
<?=$arResult1["IPROPERTY_VALUES"]["SECTION_PAGE_TITLE"];?>
<?$this->EndViewTarget();?>
