...
//$GLOBALS['ID_SECTION'] = '';
$GLOBALS['ID_SECTION'] = $arResult["VARIABLES"]['SECTION_ID'];
  ...
  if (\Bitrix\Main\Loader::includeModule("iblock")) {
    ...
    if (defined("BX_COMP_MANAGED_CACHE")) {
      ...
      if ($currentSection = $dbRes->Fetch()) {
        ...
        //poluchim nazvaniya dlya poley sortirovki
...
//); ?><!----><?php
  ...
  <?$APPLICATION->IncludeComponent(
      ...
      // podzagolovok stranitsi vivoditsya tolyko esty esty podrazdeli i/ili filytr
...
<div class="objects-content">
  <div class="objects-content-left">
    ...
    <?
//    global $arrFilter;
//    $GLOBALS['arrFilter'] = array("CITY_COUNTRY" => );
//    $GLOBALS['arrFilter'] = array("CITY_COUNTRY_VALUE" => 'Минск');
...
//    pr($GLOBALS[$arParams["FILTER_NAME"]]);
  ...
  <div class="objects-content-right">
    <?
  ...
  <div class="objects-content-switcher">
    <button class="show-map active">
      <i class="icon-on-map">Показать на карте</i>
    </button>
    <button class="show-list">
      <i class="icon-view_cards">Показать списком</i>
    </button>
  </div>
</div>
