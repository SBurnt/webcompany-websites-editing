...
<?=bitrix_sessid_post();?>
<?endif?>
<div class="bx-interface-grid-swiper">
...
<?endif?>
		<td class="bx-actions-col" width="1%"><a href="javascript:void(0);"
			...
			title="<?echo GetMessage("interface_grid_settings")?>" class="bx-action"><div class="empty"><span class="icon-service"></span></div></a></td>
<?
...
<?endif?>
	<?if(is_array($aRow["actions"]) && count($aRow["actions"]) > 0):?>
		<td class="bx-actions-col"><a href="javascript:void(0);"
			...
			title="<?echo GetMessage("interface_grid_act")?>" class="bx-action"><div class="empty"><span class="fa fa-bars"></span></div></a></td>
	<?else:?>
...
<?endif*/?>
...
</div><!-- .bx-interface-grid-swiper -->
	<script>
		var s = new Swiper(".bx-interface-grid-swiper .swiper-container", {
			slidesPerView: 'auto',
            scrollbar: {
                el: ".bx-interface-grid-swiper .swiper-scrollbar",
                hide: false,
                draggable: true,
                snapOnRelease: false
            },
	...
	<div class="bx-interface-grid-footer">
		<?if($arParams['SHOW_ALL_COUNT'] !== 'N'):?>
			<div class="bx-interface-grid-footer__all">
				<span class="bx-interface-grid-footer__all-title"><?=$arParams['FOOTER'][0]['title']?>:</span>
				<span class="bx-interface-grid-footer__all-value"><?=$arParams['FOOTER'][0]['value']?></span>
			</div>
		<?endif;?>
