...
$(function () {
	$('.js-input-selectize').each(function () {
		$(this).selectize({
			create: true,
		});
	});

	$('.js-input-selectize-ajax').each(function () {
		var entity = $(this).attr("data-src-entity");
		$(this).selectize({
			...
			*/
			load: function(query, callback) {
				...
				$.ajax({
					url: '/bitrix/tools/citrus.arealty/selectoptions.php',
					data: {
						"entity": entity,
						"q": query,
