...
$MESS["CITRUS_FILTER_FORM_ACTION_ON_SECTION_PAGE"] = "Отображать результат фильтрации на странице раздела";
$MESS["CITRUS_FILTER_FORM_MAX_ITEMS_COUNT"] = "Количество элементов до кнопки: Показать еще";
