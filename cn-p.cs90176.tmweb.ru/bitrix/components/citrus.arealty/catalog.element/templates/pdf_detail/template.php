...
/** @var CitrusArealtyCatalogElementComponent $component Tekushtiy vizvanniy komponent */
...
$newComponent = new CBitrixComponent();
$isNewComponentInit = $newComponent->initComponent('citrus:realty.catalog.element', $templateName);
if ($isNewComponentInit)
{
	$newComponent->__parent = $component;
	$isNewComponentInit = $isNewComponentInit && $newComponent->initComponentTemplate();
}
