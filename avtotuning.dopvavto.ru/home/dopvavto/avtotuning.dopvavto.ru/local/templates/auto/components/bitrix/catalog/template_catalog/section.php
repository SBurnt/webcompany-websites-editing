...
else
{
    ...
    <div class="shop">
        ...
        <div class="cat__text">
            ...
            global $arrFilter;
    $autoid;
   if( $_COOKIE['avto_marka_id']){$autoid= $_COOKIE['avto_marka_id'];}
    if($_COOKIE['avto_model_id']){$autoid=$_COOKIE['avto_model_id'];}
    if($_COOKIE['avto_god_id']){$autoid=$_COOKIE['avto_god_id'];}
   // $_COOKIE['avto_marka_id'],$_COOKIE['avto_model_id'],$_COOKIE['avto_god_id']
            $arrFilter = array(array(
				"LOGIC" => "OR",
				array("PROPERTY_COMPLET_AUTO" => array($autoid,false))
			));

    if(!$arrFilter[0][0]['PROPERTY_COMPLET_AUTO'][0]){
        $arrFilter=0;
   }
