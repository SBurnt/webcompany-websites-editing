					...
					<div class="content clearfix">
						...
						<div class="right-col rad">
							<div class="breadcrumbs">
								<a href="/" class="url rg">Главная</a><i class="fas fa-arrow-right"></i><span class="url rg">Видео</span>
							</div>
							<h2 class="shop__title category rg">Видео</h2>
							<div class="video-block">
								<div class="video-element">
									<iframe width="100%" height="215" src="https://www.youtube.com/embed/HLgBKBAobOg?list=PLEY_rQ2ErgpeyFaGuwKN611UrkHCuepsl" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
									<p>
										Шедевры авто тюнинга 2018! Длинное название видео.
									</p>
								</div>
								<div class="video-element">
									<iframe width="100%" height="215" src="https://www.youtube.com/embed/G1c80LWDMvg?list=PLEY_rQ2ErgpeyFaGuwKN611UrkHCuepsl" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
									<p>
