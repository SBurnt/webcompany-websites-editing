					...
					<div class="content clearfix">
						...
						<div class="right-col rad">
							<div class="breadcrumbs">
								<a href="/" class="url rg">Главная</a><i class="fas fa-arrow-right"></i><span class="url rg">Команда</span>
							</div>
							<h2 class="shop__title category rg">Команда</h2>
							<div class="team-block">
								<div class="img">
									<img src="public/img/pictures/team1.png" alt="">
								</div>
								<div class="info-block">
									<p class="name">
										Скрипников Максим Фёдорович
									</p>
									<p class="position">
									...
									<p class="info_item">
										<span>Дополнительное образование:</span> повышение квалификации в УО «Республиканский институт профессионального образования» по программе «Научно-методическое обеспечение подготовки, переподготовки и повышения квалификации по профессиям рабочих».
									</p>
									<p class="info_item">
										<span>Опыт работы:</span>  более 8 лет в частном учебном центре методистом и зам. директора по учебной работе.
									</p>
									<a href="#" class="phone">
										+375 (29) 288-48-48
									</a>
							...
							<div class="team-block">
								<div class="img">
									<img src="public/img/pictures/team2.png" alt="">
								</div>
								<div class="info-block">
									<p class="name">
										Скрипников Максим Фёдорович
							...
							<div class="team-block">
								<div class="img">
									<img src="public/img/pictures/team3.png" alt="">
								</div>
								<div class="info-block">
									<p class="name">
										Скрипников Максим Фёдорович
