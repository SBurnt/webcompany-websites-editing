					...
					<div class="content clearfix">
						...
						<div class="right-col rad">
							<div class="breadcrumbs">
								<a href="/" class="url rg">Главная</a><i class="fas fa-arrow-right"></i><a href="/" class="url rg">Личный кабинет</a><i class="fas fa-arrow-right"></i><span class="url rg">Смена пароля</span>
							</div>
							...
							<h2 class="shop__title category rg">Сменить пароль</h2>
							<div class="recovery-block">
								...
								<form method="post">
									...
									<label>
										<p>
											Подтвердить новый пароль <span>*</span>
										</p>
										<input type="text" class="form-element" required>
									</label>
