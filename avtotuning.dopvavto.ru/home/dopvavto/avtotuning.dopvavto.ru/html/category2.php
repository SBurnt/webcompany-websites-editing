						...
						<div class="right-col rad">
							...
							<div class="shop">
								<div class="web_popular_list">
									<a href="#" class="popular_block">
										<img src="public/img/pictures/popular1.png" alt="">
										<p class="bottom_right">
											Коврики
										</p>
									</a>
									<a href="#" class="popular_block">
										<img src="public/img/pictures/popular2.png" alt="">
										<p class="bottom_left black">
											Защита <br>
											переднего бампера
										</p>
									</a>
									<a href="#" class="popular_block">
										<img src="public/img/pictures/popular3.png" alt="">
										<p class="top_right">
											GPS - навигаторы
										</p>
									</a>
							...
							<!--<div class="sort main_flex flex__align-items_center">
								<div class="sort__controls">
									...
									<ul>
										<li class="active">названию<span class="arrow"></span></li>
										<li>цене<span class="arrow"></span></li>
										<li>рейтингу<span class="arrow"></span></li>
										<li>дате поступления<span class="arrow"></span></li>
									</ul>
								...
								<div class="shop row main_flex flex__align-items_center">
									...
									<div class="item flex__1 neon">
										...
										<div class="bg-price">1230,40<span>руб.</span></div>
										<div class="abs bd no-avalaible">Под заказ<br> 3-5 дней</div>
									</div>
								</div>
