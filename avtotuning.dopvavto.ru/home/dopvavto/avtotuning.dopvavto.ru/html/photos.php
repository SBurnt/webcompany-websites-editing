<?include( './public/tpl/header.php' );?>
			<div id="content" class="photos-content">
				<div class="wrapper">
					<div class="content clearfix">
						...
						<div class="right-col rad">
							<div class="breadcrumbs">
								<a href="/" class="url rg">Главная</a><i class="fas fa-arrow-right"></i><span class="url rg">Фото</span>
							</div>
							<h2 class="shop__title category rg">Фото</h2>
							<div class="photos-block">
								<a class="photos-element" data-fancybox="gallery" href="public/img/pictures/stock1.png">
									<img class="main-img" src="public/img/pictures/stock1.png" alt="">
									<span class="hover-block">
										<img class="zoom-img" src="public/img/pictures/plus-zoom.png" alt="">
									</span>
								</a>
								<a class="photos-element" data-fancybox="gallery" href="public/img/pictures/stock2.png">
									<img class="main-img" src="public/img/pictures/stock2.png" alt="">
									<span class="hover-block">
										<img class="zoom-img" src="public/img/pictures/plus-zoom.png" alt="">
									</span>
								</a>
								<a class="photos-element" data-fancybox="gallery" href="public/img/pictures/stock3.png">
									<img class="main-img" src="public/img/pictures/stock3.png" alt="">
									<span class="hover-block">
										<img class="zoom-img" src="public/img/pictures/plus-zoom.png" alt="">
									</span>
								</a>
