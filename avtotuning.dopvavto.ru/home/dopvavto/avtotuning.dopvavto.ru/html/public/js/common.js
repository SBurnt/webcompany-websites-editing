$(document).ready(function(){
  ...
  $('.checkout-block .customer-nav').click(function(){
    ...
    el3.height(curHeight3).animate({height: autoHeight3}, 500);
    $('.checkout-block.customer-block').addClass('opened');
  });
	$('input[type="radio"]').click(function(){
		if($('#pickup-inp').is(':checked')) {
  ...
  // });
  $('.current__min').click(function () {
    var $input = $(this).closest('.current').find('.current__num input');
...
$('.dropdown.multiple li').click(function(e){
  $(this).toggleClass('active');
