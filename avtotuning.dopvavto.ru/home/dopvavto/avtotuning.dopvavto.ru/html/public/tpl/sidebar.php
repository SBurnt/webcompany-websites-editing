			...
			<a href="#">	
				<span class="nav-ico">
					<svg width="19" height="29" viewBox="0 0 19 29" fill="none" xmlns="http://www.w3.org/2000/svg">
						<path d="M3 3C3 1.89543 3.89543 1 5 1H6.8414C7.94597 1 8.84141 1.89543 8.84141 3V4.38105C8.84141 4.93334 8.39369 5.38105 7.84141 5.38105H4C3.44772 5.38105 3 4.93334 3 4.38105V3Z" stroke-width="1.2"/>
						<path d="M1.46045 8.84082C1.46045 8.28853 1.90816 7.84082 2.46045 7.84082H9.40275C9.87944 7.84082 10.2899 8.17728 10.3833 8.6447L11.6829 15.1426L12.4148 17.7044C12.7799 18.982 11.8206 20.2538 10.4918 20.2538H4.78298C4.04486 20.2538 3.32325 20.0353 2.7091 19.6259V19.6259C1.92901 19.1058 1.46045 18.2303 1.46045 17.2928V15.8728V8.84082Z" stroke-width="1.2"/>
						<path d="M6.74216 27.3601L3.30432 24.4144C2.86717 24.0398 3.07112 23.325 3.64011 23.2374L8.64198 22.4681C10.6418 22.1604 12.6861 22.3337 14.6056 22.9736L17.0047 23.7733C17.3162 23.8771 17.5263 24.1686 17.5263 24.4969C17.5263 24.772 17.4371 25.0397 17.272 25.2597L16.7961 25.8943L16.0643 26.3811L14.6056 27.1112L13.9519 27.329C12.9329 27.6684 11.8658 27.8414 10.7918 27.8414H10.2245H8.04349C7.56618 27.8414 7.10461 27.6707 6.74216 27.3601Z" stroke-width="1.2"/>
					</svg>
				</span>
				Интерьер
			...
			<a href="#">	
				<span class="nav-ico">										
					<svg width="20" height="20" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
						<path d="M16.5938 2.96875H3.40625L1.84375 10.1562H0.15625V17.0312H19.8438V10.1562H18.1562L16.5938 2.96875ZM18.5938 15.7812H17.6562H1.40625V11.4062H2.84375L4.40625 4.21875H15.5938L16.8906 10.1562H5.46875V11.4062H18.5938V15.7812Z" fill="#FFDB6B"/>
						<path d="M17.6562 18.5938H14.8438V19.8438H17.6562V18.5938Z"/>
						<path d="M5.15625 18.5938H2.34375V19.8438H5.15625V18.5938Z"/>
						<path d="M4.21875 12.9688H2.96875V14.2188H4.21875V12.9688Z"/>
						<path d="M17.0312 12.9688H15.7812V14.2188H17.0312V12.9688Z"/>
					</svg>
				</span>
				Экстерьер
				<svg class="arrow-right" width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
			...
			<a href="#">	
				<span class="nav-ico">											
					<svg width="22" height="22" viewBox="0 0 22 22" xmlns="http://www.w3.org/2000/svg">
						...
						<path d="M14.7384 7H12.2616C12.1221 7 12 7.23333 12 7.5C12 7.76667 12.1221 8 12.2616 8H14.7384C14.8779 8 15 7.76667 15 7.5C15 7.23333 14.8779 7 14.7384 7Z"/>
					</svg>
				</span>
				Одежда, обувь, 
				аксессуары
