								...
								<ul class="catalog-new__list">
									<li class="catalog-new__list__item">
										...
										<ul>
											...
											<li><a href="#">Подогрев сидений</a></li>
											<li><a href="#">Сумки</a></li>
											<li><a href="#">Чехлы на сидения</a></li>
											<li><a href="#">Шторки багажника</a></li>
											<li><a href="#">Аксессуары для интерьера</a></li>
										</ul>
									</li>
									<li class="catalog-new__list__item">
										Экстерьер
										<ul>
											<li class="catalog-new__list__item__drop">
												<span class="catalog-new__drop-btn">Багажные системы <svg style="transform: rotate(90deg);" width="15" height="15" viewBox="0 0 15 15" fill="#fff" xmlns="http://www.w3.org/2000/svg">
												...
												<ul class="catalog-new__drop-list">
													<li><a href="#">DROP 6</a></li>
													<li><a href="#">DROP 5</a></li>
													<li><a href="#">DROP 4</a></li>
													<li><a href="#">DROP 3</a></li>
													<li><a href="#">DROP 12</a></li>
												</ul>
											</li>
											<li><a href="#">Брызговики</a></li>
											<li><a href="#">Защита переднего бампера</a></li>
											<li><a href="#">Защита заднего бампера</a></li>
											<li><a href="#">Защита кузова</a></li>
											<li><a href="#">Крышки для кузова</a></li>
											<li><a href="#">Подкрылки</a></li>
											<li><a href="#">Пороги и накладки</a></li>
									...
									<li class="catalog-new__list__item">
										Запчасти
										<ul>
											<li><a href="#">Защита двигателя и КПП</a></li>
											<li class="catalog-new__list__item__drop">
												<span class="catalog-new__drop-btn">Багажные системы <svg style="transform: rotate(90deg);" width="15" height="15" viewBox="0 0 15 15" fill="#fff" xmlns="http://www.w3.org/2000/svg">
													<rect width="9.54318" height="9.54318" transform="matrix(0.671554 -0.740955 0.671554 0.740955 1.8125 7.07129)"/>
													<rect width="9.54318" height="9.54318" transform="matrix(0.671554 -0.740955 0.671554 0.740955 0 7.07129)" fill="#0C202E"/>
									...
									<li class="catalog-new__list__item">
										Распродажа
										<ul>
											<li><a href="#">Защитные пленки для стекла и стекольных поверхностей</a></li>
											<li><a href="#">Защита заднего бампера</a></li>
											<li><a href="#">Защита кузова</a></li>
											<li><a href="#">Крышки для кузова</a></li>
											<li><a href="#">Подкрылки</a></li>
