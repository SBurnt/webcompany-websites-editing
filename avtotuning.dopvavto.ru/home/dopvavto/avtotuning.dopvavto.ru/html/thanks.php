<?include( './public/tpl/header.php' );?>
			<div id="content" class="thanks-content web-content">
				<div class="wrapper">
					<div class="content clearfix">
						...
						<div class="right-col rad">
							<div class="breadcrumbs">
								<a href="/" class="url rg">Главная</a><i class="fas fa-arrow-right"></i><a href="/" class="url rg">Личный кабинет</a><i class="fas fa-arrow-right"></i><a href="/" class="url rg">Корзина</a><i class="fas fa-arrow-right"></i><a href="/" class="url rg">Оформление заказа</a><i class="fas fa-arrow-right"></i><span class="url rg">Заказ сформирован</span>
							</div>
							<h2 class="shop__title category rg">Заказ сформирован</h2>
							<div class="thanks-block">
                <img src="public/img/pictures/thx.png" alt=""> 
                <p>
                  Ваш заказ <span>№3304</span> от 19.03.2019 15:33 успешно создан. 
                </p>
                <p>
                  Номер вашей оплаты: <span>№3304/1</span>
                </p>
                <p class="description">
                  Вы можете следить за выполнением своего заказа в <a href="#">Персональном разделе сайта</a>. Обратите 
