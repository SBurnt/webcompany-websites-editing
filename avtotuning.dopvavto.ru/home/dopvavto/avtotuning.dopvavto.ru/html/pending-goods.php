					...
					<div class="content main_flex flex__align-items_start flex__jcontent_between">
						...
						<div class="right-col">
							<div class="breadcrumbs">
								<a href="/" class="url rg">Главная</a><i class="fas fa-arrow-right"></i><a href="/profile.html" class="url rg">Личный кабинет</a><i class="fas fa-arrow-right"></i><span class="url rg">Отложенные товары</span>
							</div>
							<div class="shop">
								<h2 class="shop__title mt rg">Отложенные товары</h2>

								<div id="steps">
									<div id="step-1">
										<div class="order">
											<div class="order__table show-height">
												<table>
													<thead>
														<tr>
															<th>№</th>
													...
													<tbody class="mob-item">
														<tr>
															<td class="nmb">1</td>
															<td>
																<div class="div main_flex flex__align-items_center">
																	<img src="./public/img/img-table.png" alt="img">
																	<a href="#" class="bd">Ковёр в багажник автомобиля Kia Rio 2011</a>
																</div>
															</td>
															<td>
																<div class="current main_flex__nowrap flex__align-items_center flex__jcontent_around">
																	<div class="current__min">
																		<i class="fas fa-minus"></i>
																	</div>
																	<div class="current__num">
																		<input type="text" value="1" class="current_value">
																	</div>
																	<div class="current__max">
																		<i class="fas fa-plus"></i>
																	</div>
																</div>
															</td>
															<td class="text-center">35,40 руб.</td>
															<td>
																<div class="has-hint remove cart__add">
																	<img class="svg" src="./public/img/icon/cart.svg" width="16">
																	<div class="cloud">
															...
															<td>
																<div class="has-hint remove">
																	<img class="svg" src="./public/img/icon/cancel.svg" width="16">
																	<div class="cloud">
														...
														<tr>
															...
															<td>
																<div class="div main_flex flex__align-items_center">
																	<img src="./public/img/img-table.png" alt="img">
																	<div>
																		<a href="#" class="bd">Коврики в салон автомобиля LADA 4x4 (Niva)</a>
															...
															<td class="text-center low">
																<span class="rg low--red">61,20 руб.</span>
																<p class="rg">42,30 руб.</p>
															</td>
															<td>
																<div class="has-hint remove cart__add">
																	<img class="svg" src="./public/img/icon/cart.svg" width="16">
																...
																<div class="div main_flex flex__align-items_center">
																	...
																	<div>
																		...
																		<div class="dropdown multiple dropdown-item-inner dropdown_multiple">
																			<span class="dropdown-button" data-text="Модель">С модулем (+80 BYN)</span>
																			<ul class="dropdown-list">
																				<li data-value="С модулем (+80 BYN)">С модулем (+80 BYN)</li>
																				<li data-value="С модулем (+90 BYN)">С модулем (+90 BYN)</li>
																				<li data-value="С модулем (+100 BYN)">С модулем (+100 BYN)</li>
																				<li data-value="С модулем (+110 BYN)">С модулем (+110 BYN)</li>
																			</ul>
																		...
																		<div class="dropdown inner-dropdown">
																			...
																			<ul class="dropdown-list">
																				<li data-value="С модулем (+80 BYN)">С модулем (+80 BYN)</li>
																				<li data-value="С модулем (+90 BYN) С модулем (+90 BYN)SOME TEXT SOME TEXT">С модулем (+90 BYN) SOME TEXT SOME TEXT</li>
																				<li data-value="С модулем (+100 BYN)">С модулем (+100 BYN)</li>
																				<li data-value="С модулем (+110 BYN)">С модулем (+110 BYN)</li>
																			</ul>
																			<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" viewBox="0 0 21.9 21.9" enable-background="new 0 0 21.9 21.9" class="svg replaced-svg">
															...
															<td>
																<div class="div main_flex flex__align-items_center">
																	...
																	<div>
																		<a href="#" class="bd">Ковёр в багажник автомобиля Kia Rio 2011</a>
																		<span class="toggler">
																			<button class="rg">Этот товар может быть ещё дешевле!</button><img class='svg' src='./public/img/icon/right-angle.svg' width="7">
																		</span>
																	</div>
																</div>
															</td>
															...
															<td colspan="4" style="padding-top: 0;">
																<div class="item__discount neon">
																	<h2 class="shop__title rg">Комплект со скидкой 5%</h2>
																		<div class="item__discount--list main_flex flex__jcontent_center">
																			<div class="item__discount--item">
																				<img src="./public/img/img-item.png" alt="item">
																				<a href="#" class="bd">Автомобильный коврик в салон AUDI Q7</a>
																				<div class="rg coral">Цена: 92,40</div>
																			</div>
																			<img src="./public/img/icon/plus-black-symbol.svg" width="15" class="symbol">
																			<div class="item__discount--item">
																				<img src="./public/img/img-item2.png" alt="item">
																				<a href="#" class="bd">Автомобильный коврик в багажник AUDI Q7</a>
																				<div class="rg coral">Цена: 67,20</div>
																			</div>
																			<img src="./public/img/icon/equals-symbol.svg" width="15" class="symbol">
																		...
																		<button class="bd avalaible-is">Купить комплект</button>
																	</div>
										...
										<div id="success-order">
											<p class="rg">Ваш заказ успешно оформлен!</p>
											<p class="rg">Номер заказа: <strong>00057</strong><br>Посмотреть статус текущих заказов, историю завершённых (а также написать отзывы на купленные товары) можно в разделе <a href="/history.html">Заказы</a>.
											</p>
											<p class="rg">В ближайшее время наш менеджер свяжется с вами для подтверждения заказа. На вашу электропочту отправлено письмо с подробной информацией о заказе.</p>
											<p class="rg">Спасибо за покупку!</p>
										</div>
									</div>
