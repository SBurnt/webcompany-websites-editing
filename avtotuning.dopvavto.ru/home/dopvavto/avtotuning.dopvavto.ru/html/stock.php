				...
				<div class="wrapper">
					<div class="content clearfix">
						...
						<div class="right-col rad">
							...
							<h2 class="shop__title category rg">Акции</h2>
							<div class="stock-block">
								<a href="#" class="stock-element">
									<img src="public/img/pictures/stock1.png" alt="">
									<p class="valid">
										Действует до 11.10.19
									</p>
									<p class="stock-title">
										Комплект ковриков в салон и багажник Lada Vesta SW Cross за 105 BYN.!
									</p>
								</a>
								<a href="#" class="stock-element">
									<img src="public/img/pictures/stock2.png" alt="">
									<p class="valid">
										Действует постоянно
									</p>
									<p class="stock-title">
										При самовывозе дешевле! Коврики в салон и багажник Дено Дастер за 84 BYN!
									</p>
								</a>
								<a href="#" class="stock-element">
									<img src="public/img/pictures/stock3.png" alt="">
									<p class="valid">
										Действует постоянно
									</p>
									<p class="stock-title">
										Защита картера двигателя Hyundai/KIA со скидкой до 53%
									</p>
								</a>
								<a href="#" class="stock-element">
									<img src="public/img/pictures/stock1.png" alt="">
							...
							<div class="accordion inner-pagination main_flex flex__align-items_start flex__jcontent_center">
								<a href="#" class="accordion__prev rg">
									<img class='svg' src='./public/img/icon/left-angle.svg'>Предыдущая
								</a>
								<div class="accordion__num rg">
									<ul class="main_flex flex__align-items_start flex__jcontent_center">
										<li><a href="#">1</a></li>
							...
							<div class="breadcrumbs">
								<a href="/" class="url rg">Главная</a><i class="fas fa-arrow-right"></i><span class="url rg">Акции</span>
							</div>
						</div>
