					...
					<div class="content clearfix">
						...
						<div class="right-col rad">
							<div class="breadcrumbs">
								<a href="/" class="url rg">Главная</a><i class="fas fa-arrow-right"></i><span class="url rg">Новости</span>
							</div>
							<h2 class="shop__title category rg">Новости</h2>
							<div class="stock-block news-block">
								<a href="#" class="stock-element">
									...
									<p class="stock-title">
										Каркасные автошторки расширение ассортимента магазина!
									</p>
								</a>
								<a href="#" class="stock-element">
									<p class="date">
