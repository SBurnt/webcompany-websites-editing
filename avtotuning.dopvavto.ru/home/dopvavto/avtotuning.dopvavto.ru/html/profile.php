												...
												<div class="modal">
													...
													<form action="" id="form--modal-1">
														<div class="form__name main_flex flex__align-items_center flex__jcontent_between">
															<p class="rg">ФИО<br>(Полное имя)</p>
														...
														<div class="form__name main_flex flex__align-items_center flex__jcontent_between">
															...
															<div class="flex__1">
																<div class="form__name--p main_flex flex__align-items_center">
																	<p class="rg label-mw">Дата рождения</p>
																	<div class="date-picker">
																		<div class="input">
																			<div class="result"><span>19 апреля 1968</span>
																			</div>
																			<span class="date-ic"><img class="svg" src="./public/img/icon/calendar-with-spring-binder-and-date-blocks.svg" height="12"></span>
																		</div>
									...
									<div class="profile__info main_flex flex__align-items_start flex__jcontent_between">
										...
										<div class="profile__info--block">
											<div class="profile__info--block--row">
												<p class="rg">ФИО(Полное имя)</p>
												<div class="filler"></div>
												<p class="rg name">Иван Иванович Иванов</p>
											</div>
											<div class="profile__info--block--row">
												<p class="rg">Дата рождения</p>
												<div class="filler"></div>
												<p class="rg name">19 апреля 1968</p>
											</div>
											<div class="profile__info--block--row">
											...
											<div class="btf profile__info--block--row">
												<p class="rg">Дата регистрации</p>
												<div class="filler"></div>
												<p class="rg name">4 апреля 2018</p>
											</div>
										</div>
