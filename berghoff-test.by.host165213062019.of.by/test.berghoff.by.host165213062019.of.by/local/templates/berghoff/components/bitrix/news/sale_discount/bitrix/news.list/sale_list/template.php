...
<?foreach($arResult["ITEMS"] as $arItem):?>
    <?if($text !== $arItem['SECTION_NAME']){?>
        <a class="info-title" href="#" style="display:inline-block; margin-bottom: 15px; font-size: 20px"><?=$arItem['SECTION_NAME']?></a>
        <?$text = $arItem['SECTION_NAME'];?>
    <?}
