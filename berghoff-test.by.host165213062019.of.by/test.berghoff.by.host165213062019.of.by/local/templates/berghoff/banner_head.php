...
$arBanners = [];
$rsHeaderBanner = CIBlockElement::GetList(["SORT"=>"ASC"],["IBLOCK_ID"=>19,"ACTIVE_DATE"=>"Y","ACTIVE"=>"Y","PROPERTY_TYPE"=>105],false,false,["ID","NAME","SORT","DETAIL_TEXT","PROPERTY_LINK","PROPERTY_MAIN_PAGE","PROPERTY_LINK_TEMPLATE","PREVIEW_PICTURE"]);
