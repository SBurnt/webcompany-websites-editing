					...
					<div class="footer_bottom">
						<div class="wrap_md">
								...
								<div class="wrap_md">
									<div class="iblock copy_block">
										...
										<span class="pay_system_icons">
											...
											<?$APPLICATION->IncludeFile(SITE_DIR."include/company_information.php", Array(), Array("MODE" => "html", "NAME" => GetMessage("COMPANY_INFO")));?>
										</span>
									</div>
							...
							<div class="iblock social_block">
								...
								<div class="wrap_md">&nbsp;</div>
								<div class="wrap_md">
									<div class="empty_block iblock"></div>
									<div class="payments iblock">
										<?$APPLICATION->IncludeFile(SITE_DIR."include/payments_information.php", Array(), Array("MODE" => "html", "NAME" => GetMessage("PAYMENTS_INFO")));?>
									</div>
								</div>
