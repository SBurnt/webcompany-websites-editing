...
<div class="iblock-vote" id="vote_<?echo $arResult["ID"]?>" itemprop="aggregateRating" itemscope itemtype="http://schema.org/AggregateRating">
	<meta itemprop="ratingValue" content="<?=!$DISPLAY_VALUE ? 5 : $DISPLAY_VALUE?>" />
	<meta itemprop="reviewCount" content="<?=!intval($arResult["PROPERTIES"]["vote_count"]["VALUE"]) ? 1 : intval($arResult["PROPERTIES"]["vote_count"]["VALUE"])?>" />
