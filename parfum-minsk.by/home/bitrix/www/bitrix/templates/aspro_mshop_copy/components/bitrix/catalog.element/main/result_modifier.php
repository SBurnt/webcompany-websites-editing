...
if($productSlider){
    foreach($productSlider as $i => $arImage){
        $productSlider[$i]["BIG"] = CFile::ResizeImageGet($arImage["ID"], array("width" => 800, "height" => 600), BX_RESIZE_IMAGE_PROPORTIONAL, true, array());
        $productSlider[$i]["SMALL"] = CFile::ResizeImageGet($arImage["ID"], array("width" => 340, "height" => 340), BX_RESIZE_IMAGE_PROPORTIONAL, true, array());
        $productSlider[$i]["THUMB"] = CFile::ResizeImageGet($arImage["ID"], array("width" => 56, "height" => 56), BX_RESIZE_IMAGE_PROPORTIONAL, true, array());
    }
}
$arResult["MORE_PHOTO"]=$productSlider;
...
$arResult["PREVIEW_TEXT"] = nl2br($arResult["PREVIEW_TEXT"]);
?>