...
<div class="news_detail_wrapp ">
	...
	<?if ($arResult["PREVIEW_TEXT"]):?>
		<div class="<?if ($left_side):?>right_side<?endif;?> preview_text"><?=strip_tags($arResult["PREVIEW_TEXT"]);?></div>
	<?endif;?>
	<?if ($arResult["DETAIL_TEXT"]):?>
		<div class="detail_text <?=($arResult["DETAIL_PICTURE"] ? "wimg" : "");?>"><?=strip_tags($arResult["DETAIL_TEXT"])?></div>
	<?endif;?>
	<div class="clear"></div>
