...
// тест на списки, удалить после добавления в админку
// <button class='btnApplyNo_left_bar_service'>убрать меню</button>
$(document).ready(function () {
  $(".btnApplyNo_left_bar_service").on("click", function (e) {
    e.preventDefault();
    if ($(".container.second-page > .uk-grid").hasClass("no_left_bar_service")) {
      $(".container.second-page > .uk-grid").removeClass("no_left_bar_service");
      $(".btnApplyNo_left_bar_service").html("убрать меню");
    } else {
      $(".container.second-page > .uk-grid").addClass("no_left_bar_service");
      $(".btnApplyNo_left_bar_service").html("добавить меню");
    }
  });
});
