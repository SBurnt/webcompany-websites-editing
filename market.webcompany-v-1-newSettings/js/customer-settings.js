...
$(document).ready(function () {
    ...
    $(document).on('change', '.settings-table .settings-table-row label.checkbox input', function (e) {
       if(!!$(e.target).closest('input')){
           ...
           var post_date = '&' + input_name + '=' + input_value + '&change_site_config=1' + '&docid=' + docid + '&blockid=' + blockid;
           console.log(post_date);
           setting_change_ajax(post_date,setting_ajax_url);
       }
    });
    ...
    $("ol.ordered-list-dots.tasks__list.uk-sortable").on("change.uk.sortable", function (event, ui) {
        var parameters = [];
        var elements = {}
